...
public class AssetbundleManager : Singleton<AssetbundleManager>
{
    ...
    /// <summary>
    /// 同步加载资源，泛型，将加载好的资源实例化并返回
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="targetBundleName">目标AB包名</param>
    /// <param name="resourceName">目标资源名</param>
    /// <returns>加载出的AB资源</returns>
    ...
    /// <summary>
    /// 使用协程加载资源，并在回调函数中使用，将加载好的资源实例化并返回
    /// </summary>
    ...
    /// <summary>
    /// 异步加载资源，指定类型。AB包依然是同步加载，资源异步加载，加载完后在回掉函数中处理对象，将加载好的对象实例化并返回
    /// </summary>
    /// <param name="targetBundleName">目标包名，该包同步加载</param>
    /// <param name="resourceName">目标资源名，异步加载</param>
    ...
    /// <summary>
    /// 异步加载资源，使用泛型。AB包依然是同步加载，资源异步加载，加载完后在回掉函数中处理对象，将加载好的对象实例化并返回
    /// </summary>
    /// <param name="targetBundleName">目标包名，该包同步加载</param>
    /// <param name="resourceName">目标资源名，异步加载</param>
    /// <param name="callback">回调函数</param>
